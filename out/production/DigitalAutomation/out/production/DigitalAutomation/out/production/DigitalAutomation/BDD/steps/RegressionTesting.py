...
def step_impl(context, Deceased_FirstName, Deceased_Lastname, url, event_type : str):
    ...
    driver.switch_to_window("Funeral ceremony")
    ...
    driver.find_element_by_id("id_funeral_arrangement-charity_one").clear()
    driver.find_element_by_id("id_funeral_arrangement-charity_one").send_keys("Charity 1")
    driver.find_element_by_id("id_funeral_arrangement-charity_two").clear()
    driver.find_element_by_id("id_funeral_arrangement-charity_two").send_keys("Charity 2")
    driver.find_element_by_id("id_funeral_arrangement-event_notes").clear()
