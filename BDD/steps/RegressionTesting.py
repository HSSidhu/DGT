...
def step_impl(context, Deceased_FirstName, Deceased_Lastname, url, event_type : str):
    ...
    elem = driver.find_element_by_xpath(".//*[@id='calendar-wrapper']/div[2]/div/table/tbody/tr/td/div[2]/div/div[2]/table/tbody/tr[17]/td[2]") # time = 08:00
    ActionChains(driver).move_to_element(elem).click().perform()
    ...
    driver.find_element_by_id("id_funeral_arrangement_booking-start_1").send_keys("11:30")
