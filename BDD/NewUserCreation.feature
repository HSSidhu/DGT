...
#    |qa     |
    ...
    |location|email1|username1|lastname1|password1|
  ...
  Scenario: Create Other users using Main app for "Edinburgh" Users
    ...
    |environment|email1|password1|
    |preprod|edin.fd12@coopdigital.co.uk|Password99!|
    Then I create all the Users
    |location|email|username2|lastname2|role|
  ...
  Scenario: Create Other users using Main app for "Bolton" Users
    Given I have required login detail from user created
    |environment|email1|password1|
    |preprod|bolton.fd12@coopdigital.co.uk|Password99!|
    Then I create all the Users
    |location|email|username2|lastname2|role|
